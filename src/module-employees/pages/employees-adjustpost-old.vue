    ...
    <div class="app-container">
      <el-card :style="{minHeight:boxHeight}">
        ...
        <div class="leaveInfo">
          <el-row>
            <el-col :span="4">
              <div class="userHead" v-if="objInfoDataes.headPortrait===null"><img src="./../../assets/img.jpeg"
            ...
            <el-col :span="20">
              <div class="headInfo">
                ...
                <p>
                  <span>手机</span><em>{{objInfoDataes.mobilePhone}}</em><span>部门</span><em>{{objInfoDataes.department}}</em>
                </p>
          ...
          <el-form :rules="ruleInline" ref="dataForm" :model="formData" label-position="right">
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.post" v-model="formData.post" placeholder="1-20位字符" maxlength="20"
                            class="inputW"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" @click.stop="handleEdit($event,'post')"
                       title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
            ...
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.rank" v-model="formData.rank" placeholder="1-20位字符" maxlength="20"
                            class="inputW"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" @click.stop="handleEdit($event,'rank')"
                       title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
              ...
              <el-row :gutter="20">
                <el-col :span="12">
                  <el-row>
                    ...
                    <el-col :span="18">
                      <component v-bind:is="fileUpload" ref="positive" :formData.sync='formData'
                                 :formBase='formData'></component>
                    </el-col>
                  </el-row>
                </el-col>
              </el-row>
            ...
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.workingCity" v-model="formData.workingCity" placeholder="1-50位字符"
                            class="infoPosition"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" @click.stop="handleEdit($event,'workingCity')"
                       title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
            ...
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.taxableCity" v-model="formData.taxableCity" placeholder="1-50位字符"
                            class="infoPosition"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" @click.stop="handleEdit($event,'taxableCity')"
                       title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
            ...
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.workingPlace" v-model="formData.workingPlace" placeholder="请输入"
                            class="infoPosition"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true" @click.stop="handleEdit($event,'workingPlace')"
                       title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
            ...
            <el-form-item class="formInfo">
              <el-row :gutter="20">
                ...
                <el-col :span="1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></el-col>
                <el-col :span="11" class="editInfo">
                  <el-input v-show="editShow.recommenderBusinessPeople" v-model="formData.recommenderBusinessPeople"
                            placeholder="请输入" class="infoPosition"></el-input>
                  <div class="iconInfo">
                    <i class="fa fa-pencil-square-o" aria-hidden="true"
                       @click.stop="handleEdit($event,'recommenderBusinessPeople')" title="编辑" v-show="true"></i>
                  </div>
                </el-col>
              </el-row>
            </el-form-item>
