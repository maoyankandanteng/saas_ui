      ...
      <div class="historicalArcTop">
        <div class="title">
          ...
          <div class="yearChange">
            <el-date-picker v-model="requestParameters.year" type="year" size="mini" width="130px" placeholder="选择年"
                            value-format="yyyy" @change="handleYear"></el-date-picker>
          </div>
        </div>
      </div>
      <div class="historicalTable">
        ...
        <div class="itemes" v-for="( itemes, index) in tableData" :key="index">
          <div class="itemTopLab" :class="{act: itemes.act}">
            <div @click="openTable(itemes,index)" class="lab"><i class="fa fa-chevron-right" aria-hidden="true"></i>
            </div>
            <div>
          ...
          <div class="itemDropDown" v-show="itemes.act">
            <div class="topLab">
              <div class="fr clearfix searchInfo">
                ...
                <a class="el-button fr el-button--primary el-button--mini" title="导出"
                   @click='handleExport(itemes.month,1)'>导出</a>
              </div>
            </div>
            <el-table :data="tables" height="300" border style="width: 100%;text-align: center">
              ...
              <el-table-column prop="isThereAnyViolationOfLawOrDiscipline" label="有无违法违纪行为"
